...
# Мы вернули фильтр по дате, так как основная проблема была в парсере
DAYS_LIMIT = 90 
...
async def main():
    ...
    if unposted_articles:
        ...
        try:
            ...
            await bot.send_message(chat_id=CHANNEL_ID, text=text_to_send, parse_mode='MarkdownV2')
        ...
        # Этот блок теперь выполняется, только если список ДЕЙСТВИТЕЛЬНО пуст
